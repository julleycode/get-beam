...
from apps.api.models.agent_lead import AgentLead  # noqa: F401 — register for create_all
from apps.api.models.agent_tool_call import AgentToolCall  # noqa: F401 — register for create_all
