...
const nextConfig = {
  ...
  //
  // UNVERIFIED: it is not established that a custom Cache-Control here overrides the
  // framework-generated no-store on a dynamically rendered App Router route. Treat this
  // as a probe to be measured against real response headers after deploy, not a
  // known-good fix.
  //
