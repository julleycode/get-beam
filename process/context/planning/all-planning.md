...
description: "Plan-shape calibration (SIMPLE vs COMPLEX) and example plans — the planning group entrypoint/router"
keywords: planning, plan, PRD, spec, simple, complex, calibration, generate-plan
related: []
date: 21-07-26
---
...
This file is the canonical planning context entrypoint for Beam.
