...
class TestAC13IntervalJobHardening:
    ...
    def test_the_asserted_set_is_derived_not_hardcoded(self):
        ...
        Was 15/13/2; +1 interval job for ws2_classifier_sweep (WS2 agent-driven
        session classifier, 30-07-26). Before that 14/12/2 → +1 interval job for
        outlier_traffic_damping_sweep (27-07-26). Before that 13/12/1 → +1 cron
        job for daily_digest. Before that 12/11/1 → +1 interval job for
